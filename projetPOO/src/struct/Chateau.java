...
public class Chateau extends Structure{
	...
	/**Niveau du chateau*/
	private int lvl=1;
	/**Permet de sauver la progression d'une prod avant le lancement d'une amélioration
	 * @see Chateau#upCastle()*/
	private int prodTmp;
	/**Vrai si le chateau est en amélioration*/
	...
	/**permet de récupérer le niveau du chateau
	...
	/**Récupère l'orientation du chateau
	...
	/**Augmente la valeur du trésor correspondant à l'augmentation du trésor au cours du temps et en fonction du niveau
	 * @see Chateau#tresor*/
	...
	/**Permet l'amélioration du chateau et de garder la proggression de la production en cours
	 * @see Chateau#tmpProd
	 * @see Chateau#lvl*/
